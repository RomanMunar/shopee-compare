...
import { timeDifference } from "../../shared/utils/utils";
import { GridContainer } from "../Results/Styles";
...
const CompareItem = ({ res, index }: Props) => {
        ...
        >
          ...
          <SellerSection>
            ...
            <GridCompare>
              <div>
                <div>Followers</div>
                <span style={{ color: "#2F88FF", fontFamily: "Roboto-Bold" }}>
                  {shop.follower_count}
                </span>
              </div>
          ...
          <SectionWrapper>
            <SectionTitle>
              ...
              >
                {isDescriptionHidden ? <span>Hide</span> : <span>Show</span>}
              </Button>
            </SectionTitle>
            {isDescriptionHidden && (
              <DescriptionParagraph>
          ...
          <SectionWrapper>
            <SectionTitle>
              ...
              >
                {isRatingsSummaryHidden ? <span>Hide</span> : <span>Show</span>}
              </Button>
            </SectionTitle>

            {isRatingsSummaryHidden && (
              <RatingsSummary>
                {res.item_rating.rating_count.slice(1).map((rating, index) => (
